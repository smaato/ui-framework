...
export default class DropdownGroup extends Component {
  ...
  render() {
    ...
    const optiontolist = this.props.options.reduce(
      (accumulator, optionList, currentIndex) => (
        accumulator.concat(optionList.map((option, index) => (
          Object.assign({}, option, {
            class: classNames(this.props.optionsClass[currentIndex], {
...
DropdownGroup.propTypes = Object.assign({}, BaseDropdown.propTypes, {
  dotColor: DropdownDot.propTypes.color,
  isBorderless: PropTypes.bool,
  optionsClass: PropTypes.array,
});

DropdownGroup.defaultProps = Object.assign({}, BaseDropdown.defaultProps, {
  classes: 'dropdown',
