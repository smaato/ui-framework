...
describe('ModalStack', () => {
  describe('Props', () => {
    describe('children', () => {
      it('are rendered', () => {
        ...
        const testCase = TestCaseFactory.create(ModalStack, props);
  ...
  describe('stacking logic', () => {
    ...
    it('assigns a depthMax class to levels of depth after 3', () => {
      ...
      expect(stackedModals[2].className)
        .not.toContain('stackedModal--depthMax');
      expect(stackedModals[3].className)
        .not.toContain('stackedModal--depthMax');
      expect(stackedModals[4].className)
        .not.toContain('stackedModal--depthMax');
    });
  });
});
